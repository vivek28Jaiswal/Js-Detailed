...
console.log(another.flat(Infinity)); //flat() method basically concatented krta hai more than two arrays ko and isme hum dept choose kr skte hai kitne array tak chahiye hume concat array
